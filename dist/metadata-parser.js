...
const sandbox = async () => {
    ...
    for (let i = 1; i <= 10000; i++) {
        ...
        const final = [first.replace('generate', 'Smile Zombie'), `"image": "https://images.membersplus.com/prod/jdb/smile-zombie/image/${i}.png", "description": "Smile Zombies invite people to SZ-ZONE with the spirit of \\"Zombies never die, laughter never dies,\\" and join forces for laughter and happiness.",`, second].join('');
        console.log(final);
        if (i <= 1000) {
